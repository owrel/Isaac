...
from dialoguemanager.intents import Intent
import dialoguemanager.intents
from datetime import datetime
import worker.worker as worker


# worker.CreateIntents()
    ...
    def DM(self):
        ...
        while q == False:
            ...
            try:
                ...
                print(f'It seems like no worker called "{current_intent_name}" exist. Should I add a skeleton function to the worker file ?')
                ui = input('#: ')
